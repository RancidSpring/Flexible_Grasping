...
class Hand:
    ...
    def __init__(self, world, hand='kuka'):
        ...
        self.worldPosition1 = [0, 0, 0]
        self.worldPosition2 = [0, 0, 0]
        self.worldPosition3 = [0, 0, 0]
        self.worldPosition4 = [0, 0, 0]
...
class GLPickAndPlacePlugin(GLPluginInterface):
    ...
    def display(self):
        ...
        glColor3f(0.5, 0.3, 0)
        glVertex3fv([0.54, 0.24, 0.23])
        glColor3f(0.5, 0.3, 0)
        glVertex3fv([0.54, 0.16, 0.23])
        glColor3f(0.5, 0.3, 0)
        glVertex3fv([0.46, 0.16, 0.23])
    ...
    def upload_constraints(self):
        ...
        for i in range(constraints_num):
            ...
            for ind in indeces:
                ...
                print("CURRENT_VERTECES", verti_arr[ind[0]], verti_arr[ind[1]], verti_arr[ind[2]])
                print("CENTER", center_of_face)
