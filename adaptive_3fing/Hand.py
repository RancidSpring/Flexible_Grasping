...
from utilities.open3fing_adaptive import openhand
from utilities.open3fing_adaptive import open_free
...
class Hand:
    ...
    def __init__(self, world, hand='kuka'):
        self.hand = hand
        self.gripper = "3fing_adaptive"
        self.fingerLink1 = 21
        self.fingerLink2 = 24
        self.fingerLink3 = 27
        self.armIndices = range(6, 13)
        self.handIndices = range(15, 28)
        self.active_fingers = 3
        ...
        for i in range(i_old, 4):
            ...
            for j in range(j_old, 4):
                ...
                for k in range(k_old, 4):
                    ...
                    goal = ik.objective(robot.link("kuka[tool0]"),
    ...
    def goal_transform_transit(self, robot, cspace):
        ...
        while True:
            ...
            if res is not None:
                ...
                self.grasped_face1 = n1.ind
                self.grasped_face2 = n2.ind
                print("Solved within first ", cnt, "iterations,", " soving time: ", end - start)
                return res
            else:
                print("Couldn't find grasp")
