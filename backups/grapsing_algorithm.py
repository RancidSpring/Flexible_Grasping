...
class Hand:
    ...
    def __init__(self, world, hand='kuka'):
        ...
        self.worldPosition1_saved = None
        self.worldPosition2_saved = None
        self.worldPosition3_saved = None
...
class GLPickAndPlacePlugin(GLPluginInterface):
    ...
    def save_to_csv(self):
        ...
        savetxt('grasping_database/cube_grasp_uti.csv', asarray(cube_grasp_utility), delimiter=',')
        return True

    def data_lenght(self):
        print("Dataset consists of ", len(self.data)/3, "points")
        return
